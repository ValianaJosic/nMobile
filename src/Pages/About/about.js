  ...
  return (
    <div className="about">
      ...
      <div className="intro-div">
        ...
        <p>Extend your business beyond your office walls with a personalized App tailored to your industry.</p>
      ...
      <p className="about-info">We install a nMobile server that connects to your ERP software efficiently and without modifying the base code. We have an ample amount of existing functionality and provide a way to manage the software via web tools. You can create additional UIs, change captions, add/remove columns, add a function triggered by unlimited action buttons, change properties, all without coding. Action buttons allow you to add unlimited functionality.
        ...
        <p>• Warehouse solutions are scanning millions of records from multiple countries without affecting ERP performance.</p>
        <p>• Restaurant solutions that do not require a POS system, tablets or computers in the Restaurant. Control Inventory, Purchases, Sales, Events, Catering, Deliveries with no human interaction (how cool is that for our new remote world!).</p>
        <p>• Social Media marketing tools that allow you to post your campaigns automatically and check results directly in your ERP.</p>
        <p>• Service orders where drivers/technicians receive their orders on a tablet or phone. The App guides them to each of the clients. The Technician can check Inventory or even place an order for a part. The client can download the same App and check service repair status, pay, and make appointments.</p>
